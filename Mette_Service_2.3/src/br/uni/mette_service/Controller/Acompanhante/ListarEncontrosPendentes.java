...
public class ListarEncontrosPendentes extends ListActivity 
										implements OnClickListener{
	//---------
private Button btnVoltarPnd;
Usuario usuarioLogado = new Usuario();
    ...
    private void adicionarFindView() {
		this.btnVoltarPnd = (Button) findViewById(R.id.btnVoltarPnd);
	}
    public void adicionarListers() {
		this.btnVoltarPnd.setOnClickListener(this);
    ...
    class ServicosAsyncTask extends AsyncTask<Void, Void, Modelo> {
    	...
    	protected void onPreExecute() {
    		...
    		dialog = ProgressDialog.show(
    				ListarEncontrosPendentes.this, 
    				"Aguarde", "Baixando Encontros Pendentes...", true, false);
    	}
    	...
    	protected Modelo doInBackground(Void... params) {
			...
			encontroRetorno = repositorio.acessarServidor("listarEncontrosPendentesPorIdAcompanhante", modelo);
...
//    					Encontro encontroRetorno = new Acompanhante();
    					
    					//sets no encontro Retorno a partir do objectJson
    					

        				//Log.i("SOSTENES", i +"..." + encontroRetorno.getNome() + "..."+ encontroRetorno.getIdade());
...
//        				addEncontro.add(encontroRetorno);
    				...
    				//----
//    	    			setListAdapter(
//    	    					new AcompanhanteAdapter(ListarEncontrosPendentes.this, 
//    	    							addEncontro));
