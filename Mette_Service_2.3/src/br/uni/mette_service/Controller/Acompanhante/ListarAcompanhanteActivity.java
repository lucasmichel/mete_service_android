...
public class ListarAcompanhanteActivity extends ListActivity{
	...
	class MeninasAsyncTask extends AsyncTask<String, String, AcompanhanteList>{
		...
		protected AcompanhanteList doInBackground(String... params) {
			...
			AcompanhanteList objacompanhante = new AcompanhanteList();
			try 
			
			{
				
				AcompanhanteList acompanhanteRetorno = new AcompanhanteList();

				acompanhanteRetorno = objacompanhante.listarAcompanhante(objacompanhante);
